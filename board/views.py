...
def view(request):
    ...
    # print(form['bno'])
        ...
        # 본문글 조회
        # select * from board inner join member using(id) where id = ???  .get이 where절
...
# 게시판 글쓰기 처리
# get이면 board/write.html
# post면 작성한 글을 디비에 저장, 'board/list.html'로 이동
def write(request):
